...
const headCells = [
  ...
  { id: 'arithmetic_mean', numeric: false, disablePadding: false, label: 'arithmetic_mean' },
  { id: 'arithmetic_standard_dev', numeric: false, disablePadding: false, label: 'arithmetic_standard_dev' },
];
...
export default function EnhancedTable() {
  ...
  useEffect(() => {
    fetch("http://localhost:8080/demo/measure")
      .then(res => res.json())
      .then(
        (result) => {
          setIsLoaded(true);
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell>{row.arithmetic_mean}</TableCell>
                      <TableCell>{row.arithmetic_standard_dev}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
